...
class generator(nn.Module):
    ...
    def __init__(self, dim_noise=100, dim_output_img=64):
        ...
        self.conv_trans_2d1 = nn.ConvTranspose2d(dim_noise, dim_output_img*8, 4, 1, 0, bias=False)
        ...
        self.conv_trans_2d6 = nn.ConvTranspose2d(dim_output_img, 3, 4,2,1, bias=False)
        self.tanh = nn.Tanh()
...
class discriminator(nn.Module):
    ...
    def __init__(self, dim_input_img=64):
        ...
        self.conv1 = nn.Conv2d(3, dim_input_img, 4, 2,1, bias=False)
        ...
        self.conv6 = nn.Conv2d(dim_input_img * 8, 1, 4, 1, 0, bias=False)
        self.sig = nn.Sigmoid()
...
def train_base(epochs, batch_size, dim_noise, dim_img, device, dataset, generator, discriminator, loss, optimizer_gen, optimizer_dis, filepath=None, filename='dcgan_epoch.pth'):
    ...
    for e in range(epochs):
        ...
        for i, data in enumerate(dataloader):
            ...
            output_dis_ns = discriminator(output_gen.detach()).view(-1) # use .detach() to stop the requirement of gradient
